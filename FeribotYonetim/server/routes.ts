...
import { transferRouter, transferAdminRouter } from "./routes/transfer-routes";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Transfer modülü (havaalanı / şehir içi transfer)
  app.use('/api/transfer', transferRouter);
  app.use('/api/admin/transfer', transferAdminRouter);
...
Sitemap: https://ferrybooking.web.tr/sitemap.xml`;
  ...
  // Transfer Modülü API uçları services/transfer-service.ts + routes/transfer-routes.ts
  // içine taşındı ve yukarıda app.use('/api/transfer', ...) ile kaydedildi.
  // Buradaki eski uçlar storage.getTransferVehicleTypes() gibi hiç yazılmamış
  // metotları çağırdığı için her istekte TypeError atıyordu.
